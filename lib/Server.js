...
class Server {
  ...
  checkHeader(headers, headerToCheck) {
    ...
    // Note: IP addresses are only allowed if they match this.options.host
    // to prevent Cross-site WebSocket hijacking (CVE-2025-30360)
    const isValidHostname =
      hostname === "localhost" || hostname === this.options.host;
